...
class Bird(pg.sprite.Sprite):
    def __init__(self,scale_factor):
        ...
        self.img_list=[pg.transform.scale_by(pg.image.load("gallery/game img/downbird.png").convert_alpha(),scale_factor),
                       pg.transform.scale_by(pg.image.load("gallery/game img/upbird.png").convert_alpha(),scale_factor)]
        self.image_index=0
